		...
		Type.Object(
			{
				...
				criteria: Type.Optional(
					Type.Object({ true: text, false: text }, { additionalProperties: false }),
				),
			},
...
export function parseRequest(value: unknown): Request {
	...
	const visit = (item: unknown, depth: number): void => {
		...
		if (typeof item === "string") {
			...
			if (bytes > 48000) throw new Error("Jev request exceeds 48,000 bytes; narrow the context.");
			return;
		}
		...
		if (![Object.prototype, Array.prototype, null].includes(Object.getPrototypeOf(item)))
	...
	if (!Value.Check(requestSchema, value))
		throw new Error("Expected state and 1–32 valid Noul, Choice or Score questions.");
